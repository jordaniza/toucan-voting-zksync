...
import {IOAppOptionsType3, EnforcedOptionParam} from "contracts/layer-zero/LayerZero-v2/oapp/contracts/oapp/interfaces/IOAppOptionsType3.sol";
...
abstract contract OAppOptionsType3Upgradeable is IOAppOptionsType3, AragonOAppAuthorizable {
    ...
    ) public virtual auth(OAPP_ADMINISTRATOR_ID) {
