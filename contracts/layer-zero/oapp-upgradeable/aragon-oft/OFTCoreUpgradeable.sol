...
import {IOFT, SendParam, OFTLimit, OFTReceipt, OFTFeeDetail, MessagingReceipt, MessagingFee} from "contracts/layer-zero/LayerZero-v2/oapp/contracts/oft/interfaces/IOFT.sol";
import {IOAppMsgInspector} from "contracts/layer-zero/LayerZero-v2/oapp/contracts/oapp/interfaces/IOAppMsgInspector.sol";

import {OFTMsgCodec} from "contracts/layer-zero/LayerZero-v2/oapp/contracts/oft/libs/OFTMsgCodec.sol";
import {OFTComposeMsgCodec} from "contracts/layer-zero/LayerZero-v2/oapp/contracts/oft/libs/OFTComposeMsgCodec.sol";

import {OAppUpgradeable, Origin} from "contracts/layer-zero/oapp-upgradeable/aragon-oapp/OAppUpgradeable.sol";
    ...
    OAppOptionsType3Upgradeable
{
    ...
    /// @dev UPGRADES removed immutability
    ...
    /**
     * @dev UPGRADES replaced constructor
     ...
     */
    function setMsgInspector(address _msgInspector) public virtual auth(OAPP_ADMINISTRATOR_ID) {
