...
import {IERC20BurnableUpgradeable} from "contracts/interfaces/IERC20BurnableUpgradeable.sol";
import {IERC20MintableUpgradeable} from "contracts/interfaces/IERC20MintableUpgradeable.sol";
    ...
    DaoAuthorizableUpgradeable
{
    ...
    function burn(
        address from,
        uint256 amount
    ) external auth(BURN_PERMISSION_ID) {
        _burn(from, amount);
    }
